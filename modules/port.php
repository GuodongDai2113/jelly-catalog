...
class Port
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_post_jc_export_product_categories', [$this, 'export_product_categories']);
        add_action('admin_post_jc_export_products_json', [$this, 'export_products_json']);
...
<?php
    ...
    public function export_product_categories()
    {
        ...
        usort($categories, ['Jelly_Catalog\Utils', 'sort_terms_by_depth']);
    ...
    private function get_export_field_definitions()
    {
        ...
        if (Utils::is_rank_math_active()) {
            $definitions['rank_math_focus_keyword'] = [
                'header' => 'Focus Keyword',
                'label' => __('Focus Keyword', 'jelly-catalog'),
                'default' => true,
            ];
            $definitions['rank_math_title'] = [
                'header' => 'SEO Title',
                'label' => __('SEO Title', 'jelly-catalog'),
                'default' => true,
            ];
            $definitions['rank_math_description'] = [
    ...
    private function sort_export_products_json_payload($payload)
    {
        ...
        usort($payload, function ($left, $right) {
    ...
    private function get_export_product_field_value($field_key, $product, $export_dir, $export_images)
    {
        ...
        switch ($field_key) {
            ...
            case 'tags':
                return implode('|', wp_get_post_terms($post_id, 'product_tag', ['fields' => 'names']));
            case 'faqs':
    ...
    private function get_export_product_category_name_paths($post_id)
    {
        ...
        usort($terms, ['Jelly_Catalog\Utils', 'sort_terms_by_depth']);
        $paths = [];
