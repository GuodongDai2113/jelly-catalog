...
class Post_Meta_Box {
	...
	public function add_help() {
		...
		$screen->add_help_tab(
			array(
				'id'      => 'postimagediv_help',
				'title'   => __( 'Product Image', 'jelly-catalog' ),
				'content' => '<div class="edit-description">
                <p class="edit-title"><span class="dashicons dashicons-info-outline"></span>' . esc_html__( 'Featured Image Guidelines:', 'jelly-catalog' ) . '</p>
                <ol>
                    <li>' . esc_html__( 'Upload a clear primary product image with a clean background whenever possible.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Use consistent aspect ratios across products to keep archive pages visually aligned.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Prefer images that highlight the product structure, material, and main selling point at a glance.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Avoid watermarks, excessive text overlays, or overly compressed images.', 'jelly-catalog' ) . '</li>
                </ol>
            </div>',
			)
		);
		...
		$screen->add_help_tab(
			array(
				'id'      => 'product-images_help',
				'title'   => __( 'Product Gallery', 'jelly-catalog' ),
				'content' => '<div class="edit-description">
                <p class="edit-title"><span class="dashicons dashicons-info-outline"></span>' . esc_html__( 'Gallery Usage Guidelines:', 'jelly-catalog' ) . '</p>
                <ol>
                    <li>' . esc_html__( 'Add multiple supporting images to show different angles, details, dimensions, or use cases.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Keep gallery image quality and visual style consistent with the featured image.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Sort images in a logical order, placing the most informative views first.', 'jelly-catalog' ) . '</li>
                    <li>' . esc_html__( 'Remove duplicate or low-value images so the gallery stays focused and helpful.', 'jelly-catalog' ) . '</li>
                </ol>
            </div>',
			)
		);
