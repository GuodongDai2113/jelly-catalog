...
class JC_Product_Cat_Thumbnail_Metabox
{
    ...
    {
        add_action('product_cat_edit_form_fields', [$this, 'edit_thumbnail_field']);
        add_action('edited_product_cat', [$this, 'save_thumbnail_field']);
    }
        ...
        <div id="thumbnail_id_container">
            ...
            <p>
                <button class="button button-secondary"
                    id="thumbnail_id_button"><?php esc_html_e('Select Thumbnail', 'jelly-catalog'); ?></button>
                <button class="button button-secondary remove-thumbnail"
                    style="<?php echo $thumbnail_id ? '' : 'display: none;'; ?>"><?php esc_html_e('Remove Thumbnail', 'jelly-catalog'); ?></button>
            </p>
        </div>
        <p class="description"><?php esc_html_e('Select a thumbnail for this product category.', 'jelly-catalog'); ?>
        </p>
    </td>
</tr>
<?php
