...
class Product extends Single_Base
{
    ...
    public static function get_properties()
    {
        ...
        $properties['export_group'] = 'theme-builder';
    ...
    {
        return esc_html__('Single Product', 'jelly-catalog');
    }

    public static function get_plural_title()
    {
        return esc_html__('Single Products', 'jelly-catalog');
    }
    ...
    public static function get_editor_panel_config()
    {
        ...
        $config['widgets_settings']['jc-product-content'] = [
            'show_in_panel' => true,
        ];
