...
class Product_Cat_Faq extends \Elementor\Widget_Base
{
    ...
    protected function content_template(): void
    {
        $preview_faqs = [
            [
                'name' => esc_html__('What category information appears here?', 'jelly-catalog'),
                'value' => esc_html__('This preview shows the category FAQ layout when the selected archive has no FAQ data.', 'jelly-catalog'),
            ],
            [
