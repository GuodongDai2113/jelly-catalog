...
/**
 * addons\elementor\tags\product-cat-banner.php
 * 
 * @see: https://jellydai.com
 * @author: Jelly Dai <daiguo1003@gmail.com>
 * @created : 2025.11.02 22:34
 */
...
class Product_Cat_Banner extends \ElementorPro\Modules\DynamicTags\Tags\Base\Data_Tag
{
	use Tag_Trait;
	...
	{
		return 'jc-product-cat-banner-tag';
	}

	public function get_title()
	{
		return esc_html__('Category Banner', 'jelly-catalog');
	}
	...
	public function get_value(array $options = [])
	{
		...
		if ($category_id) {
			$image_data = $this->get_category_banner_data($category_id);
		} else {
	 ...
	 * @return array
	 */
	private function get_category_banner_data($category_id)
	{
		$image_id = get_term_meta($category_id, 'banner_id', true);
